...
export const getRipostes = async (cb) => {
    ...
    const ripostes = data.map((r) => new Riposte(
        r.uuid,
        r.title,
        r.body,
        r.source_url,
...
export const updateRiposte = (riposte) => apiClient.put(`api/v3/ripostes/${riposte.id}`, {
    uuid: riposte.id,
    title: riposte.title,
    body: riposte.body,
...
export const createRiposte = (riposte) => apiClient.post('api/v3/ripostes', {
    uuid: riposte.id,
    title: riposte.title,
    body: riposte.body,
    source_url: riposte.url,
