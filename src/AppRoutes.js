  ...
  return (
    <Suspense fallback={<Spinner />}>
      <Routes>
        ...
        <Route path={paths.adherents} element={authorizedPages.includes(pages.contacts) && <Adherents />} />
        <Route path={`${paths.messagerie}/*`} element={authorizedPages.includes(pages.messages) && <Messagerie />} />
