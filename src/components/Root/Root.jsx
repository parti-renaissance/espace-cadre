...
const Root = () => {
    ...
    if (pathname === '/') {
        content = <span className="pageTitle mr-3">Dashboard</span>;
    } else if (pathname === '/contacts') {
        content = <span className="pageTitle mr-3">Contacts</span>;
    } else if (pathname === '/mail') {
        content = <span className="pageTitle mr-3">Messagerie</span>;
    }
                        ...
                        <div className="page-content" id="content">
                            <div className="container-fluid mt-3">
                                <div className="row d-flex headerRow pl-3 mb-3">
                                    <button id="sidebarCollapse" className="mr-3 mt-2" type="button">
                                        <i className="fa fa-bars mr-2" />
                                        <span className="menuText">Menu</span>
                                    </button>
                                    {content}
                                    {currentUser && (
                                        <div className="welcomeMessage ml-sm-auto mr-3 mt-3">
