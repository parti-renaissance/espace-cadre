...
import Iconify from 'src/mui/iconify'
      ...
      defaultProps: {
        slots: {
          ...
          columnSortedAscendingIcon: () => (
            <Iconify width={20} icon="solar:alt-arrow-up-bold-duotone" sx={{ color: 'text.primary' }} />
          ),
          columnSortedDescendingIcon: () => (
            <Iconify width={20} icon="solar:alt-arrow-down-bold-duotone" sx={{ color: 'text.primary' }} />
          ),
          columnUnsortedIcon: () => (
            <Iconify width={20} icon="solar:alt-arrow-up-bold-duotone" sx={{ color: 'text.disabled' }} />
          ),
          columnMenuIcon: () => <Iconify width={20} icon="mingcute:more-1-fill" />,
          columnMenuSortAscendingIcon: () => <Iconify width={20} icon="solar:alt-arrow-up-bold-duotone" />,
          columnMenuSortDescendingIcon: () => <Iconify width={20} icon="solar:alt-arrow-down-bold-duotone" />,
          ...
          columnFilteredIcon: () => <Iconify width={16} icon="solar:filter-bold" sx={{ color: 'text.primary' }} />,
          // density
          densityCompactIcon: () => <Iconify width={20} icon="material-symbols:table-rows-narrow-rounded" />,
          ...
          // quick filter
          quickFilterIcon: () => <Iconify width={24} icon="eva:search-fill" sx={{ color: 'text.secondary' }} />,
