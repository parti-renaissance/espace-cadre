  ...
  describe('The modal', () => {
    ...
    describe('The Title and Territory part', () => {
      ...
      it('should have a fillable input', () => {
        cy.get(ModalContainer).find(TitleInput).find('input').should('exist').invoke('attr', 'name').should('eq', 'title')
        cy.get(ModalContainer).find(TitleInput).find('input').type('My Title')
      })

      it('should have a no fillable input', () => {
        cy.get(ModalContainer).find(TerritoryInput).find('input').should('exist').invoke('attr', 'name').should('eq', 'territory')
      ...
      describe('The question part', () => {
        ...
        it('should have a content label', () => {
          cy.get(ModalContainer).find(QuestionContentLabel).should('exist').and('be.visible').and('have.text', 'Question')
        })

        it('should have a content input', () => {
          cy.get(ModalContainer).find(QuestionContentInput).find('input').should('exist').invoke('attr', 'name').should('eq', 'content')
        ...
        it('should have a clickable delete button on the input', () => {
          ...
          cy.get(ModalContainer).find(QuestionDeleteButton).click().then(() => {
            cy.get(ModalContainer).find(QuestionContentInput).find('input').its('length').should('eq', 1)
          })
        })
        ...
        it('should have a clickable add button below the input', () => {
          ...
          cy.get(ModalContainer).find(QuestionAddButton).find(Typography).should('have.text', 'Ajouter une question').and('be.visible')
          cy.get(ModalContainer).find(QuestionAddButton).click().then(() => {
      ...
      describe('The question type part', () => {
        ...
        it('should have 3 selectable options', () => {
          ...
          cy.get(ModalContainer).find(QuestionTypeSimpleField).children().eq(1).should('have.text', 'Réponse libre').and('be.visible')
          ...
          cy.get(ModalContainer).find(QuestionTypeMultipleChoice).children().eq(1).should('have.text', 'Choix multiples').and('be.visible')
          ...
          cy.get(ModalContainer).find(QuestionTypeUniqueChoice).children().eq(1).should('have.text', 'Choix uniques').and('be.visible')
        })
      })
    })
    ...
    describe('The choices part', () => {
      it('should not have any choice for a "simple field" question', () => {
          cy.get(ModalContainer).find(QuestionTypeSimpleField).children().eq(0).click().then(() => {
      ...
      it('should have 3 choices for a "multiple choices" question', () => {
        cy.get(ModalContainer).find(QuestionTypeMultipleChoice).children().eq(0).click().then(() => {
      ...
      it('should have 3 choices for a "unique choice" question', () => {
          cy.get(ModalContainer).find(QuestionTypeUniqueChoice).children().eq(0).click().then(() => {
          cy.get(ModalContainer).find(ChoicesLabel).should('exist').and('be.visible')
          cy.get(ModalContainer).find(ChoicesLabel).should('exist').and('be.visible')
          cy.get(ModalContainer).find(ChoiceInput).should('exist').and('be.visible')
          cy.get(ModalContainer).find(ChoiceDeleteButton).should('exist').and('be.visible')
      ...
      it('should have a clickable delete button on the input', () => {
        cy.get(ModalContainer).find(QuestionTypeMultipleChoice).children().eq(0).click().then(() => {
          ...
          cy.get(ModalContainer).find(ChoiceDeleteButton).click().then(() => {
      ...
      it('should have a clickable add button below the input', () => {
        cy.get(ModalContainer).find(QuestionTypeUniqueChoice).children().eq(0).click().then(() => {
          ...
          cy.get(ModalContainer).find(ChoiceAddButton).find(Typography).should('have.text', 'Ajouter un choix').and('be.visible')
          cy.get(ModalContainer).find(ChoiceAddButton).click().then(() => {
