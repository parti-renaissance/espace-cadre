...
describe('Committees', () => {
  beforeEach(() => {
    ...
    mock(
      ...
      'committees/committeeDetail/designations'
    )
  ...
  describe('the committees list with "closed" designation', () => {
    beforeEach(() => {
      ...
      mock(
        'GET',
        '/api/v3/committee_elections/68742184-822f-4883-b00c-ec68dc09a7ff?scope=referent',
        'committees/committeeDetail/committee-election'
      )
      mock(
        'GET',
        '/api/v3/designations/5eeda2a3-71a4-499b-a7d1-cf52ff2a7604/results?scope=referent',
        'committees/committeeDetail/results'
      )
    })
  ...
  describe('committees with "not_started" designation', () => {
    beforeEach(() => {
      ...
      mock(
        'GET',
        '/api/v3/committee_elections/68742184-822f-4883-b00c-ec68dc09a7ff?scope=referent',
        'committees/committeeDetail/committee-election-not-started'
      )
      mock(
        'POST',
        '/api/v3/committee_candidacies_groups?scope=referent',
        'committees/committeeDetail/candidacies-groups'
      )
      mock('POST', '/api/v3/committee_candidacies?scope=referent', 'committees/committeeDetail/candidacies')
      mock(
        'GET',
        '/api/v3/designations/5eeda2a3-71a4-499b-a7d1-cf52ff2a7604/results?scope=referent',
        'committees/committeeDetail/no-results'
      )
    })
    ...
    it('can add candidacies groups and candidates', () => {
      ...
      cy.get(CandidaciesGroupCard).eq(0).find('> div + div').click()
      cy.contains('Les candidats')

      cy.get(CandidaciesGroupCard).eq(0).find('> div + div').find(AddCandidateButton).click()
      ...
      cy.get(CandidaciesGroupsContainer).find(CandidatesListItem).eq(0).children().should('have.length', 1)
    })
  })
  ...
  describe('committees with "scheduled" designation', () => {
    beforeEach(() => {
      mock(
        'GET',
        '/api/v3/committee_elections/68742184-822f-4883-b00c-ec68dc09a7ff?scope=referent',
        'committees/committeeDetail/committee-election-scheduled'
      )
      mock(
        'GET',
        '/api/v3/designations/5eeda2a3-71a4-499b-a7d1-cf52ff2a7604/results?scope=referent',
